...
public String toString() {
	return "Acquisto [idAcquisto=" + idAcquisto + ", tipoSpedizione=" + tipoSpedizione + ", dataInizio=" + dataInizio
			+ ", dataFine=" + dataFine + ", prezzoTotale=" + prezzoTotale + ", quantitaAcquistata=" + quantitaAcquistata
...
=======
	...
	public String toString() {
		return "Acquisto [idAcquisto=" + idAcquisto + ", tipoSpedizione=" + tipoSpedizione + ", dataInizio="
				+ dataInizio + ", dataFine=" + dataFine + ", prezzoTotale=" + prezzoTotale + ", quantitaAcquistata="
